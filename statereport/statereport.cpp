...
// eosio-coo -I src/external/history-tools/libraries/eosiolib/wasmql -I src/external/date/include -I src/external/eosio.cdt/libraries/eosiolib/capi -I src/external/eosio.contracts/contracts/eosio.system/include -I src/external/history-tools/libraries/eosiolib/wasmql/eosio/temp_placeholders.cpp -fquery-server  --eosio-imports=src/external/history-tools/libraries/eosiolib/wasmql/server.imports statereport/statereport.cpp --contract=statereport -o build/statereport.abi
